                ...
                if (isset($_GET['status'])) {
                    ...
                    switch ($errorCode) {
                        ...
                        case 'sentemailfailed':
                            ...
                            echo '<p style="color:red; font-weight: bold; text-align:center">Kindly Login</p>';
                            break;
                        case 't_success':
                            echo '<p style="color:green; font-weight: bold; text-align:center">Therapist Added Successfully</p>';
                            break;
                        case 'allfieldrequired': 
                            echo '<p style="color:green; font-weight: bold; text-align:center">All fields are required</p>';
                            break;
                        ...
                        case 'useroremailtaken':
                            ...
                            break;
                        case 'th_deleted':
                            echo '<p style="color:red; font-weight: bold; text-align:center">Therapist Successfully deleted</p>';
                            break;                            
                        default:
